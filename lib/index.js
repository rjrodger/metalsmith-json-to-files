...
var plugin = function plugin (options) {
    ...
    // shouldn't this extend rather than override?
    var properties_to_remove = options.properties_to_remove || Object.keys(metadata_schema);
    var properties_to_hoist  = options.properties_to_hoist || [];
    ...
    return function (files, metalsmith, done) {
	    ...
	    // Validate metadata params
            ...
            json.forEach(function (element) {
                ...
                properties_to_hoist.forEach(function (property_to_hoist) {
                    data[property_to_hoist] = element[property_to_hoist]
                });
